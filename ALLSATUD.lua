...
local DinoWindow = Dino:CreateWindow("All Star Tower Defense")
local DinoPage = DinoWindow:NewPage("Main")
local Home = DinoPage:NewSection("Main")

    Home:CreateToggle("Redeem All Code",function(value)
_G.RA = value
while _G.RA do wait() 
local args = {
    [1] = "Code",
...
game:GetService("ReplicatedStorage").Remotes.Server:InvokeServer(unpack(args))
    ...
    Home:CreateButton("Summon Em 1 Time",function(value)
local args = {
    [1] = "SummonStart",
    [2] = 3
}
...
game:GetService("ReplicatedStorage").Remotes.Server:InvokeServer(unpack(args))
    ...
    Home:CreateToggle("Trade Em",function(value)
_G.Trade = value
while _G.Trade do wait()
local args = {
    [1] = "SwapGems"
}
